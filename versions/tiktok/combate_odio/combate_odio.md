...
* **Atributos protegidos** significam caraterísticas pessoais com as quais você nasceu, que são imutáveis ou causariam danos psicológicos graves se você fosse forçado(a) a alterá-las ou fosse atacado(a) por causa delas. Nós também oferecemos algumas proteções relacionadas à idade e podemos considerar outros atributos protegidos quando tivermos contexto adicional, como informações específicas fornecidas por uma ONG (organização não governamental) local. Os atributos são informados pela [Declaração Universal dos Direitos Humanos](https://www.un.org/en/about-us/universal-declaration-of-human-rights) e convenções internacionais.

Para adotar os direitos humanos internacionais e uma conduta justa para atenuar o preconceito e a discriminação, contratamos diversos especialistas em políticas, incluindo especialistas em comportamento de ódio e direitos humanos. Também consultamos extensivamente especialistas externos em diferentes áreas de interesse para garantir que estamos considerando diversas perspectivas e experiências vividas ao desenvolver nossas políticas e outras medidas de segurança.

Dependendo do indivíduo ou grupo alvo, o comportamento de ódio pode parecer diferente e exigir estratégias personalizadas para combatê-lo. Por isso que desenvolvemos estratégias de segurança que ajudam a proteger vários grupos, por exemplo, limitando a descoberta de termos de ódio e se antecipando às teorias da conspiração que podem prejudicar comunidades vulneráveis. Por exemplo, removendo conteúdo "holofóbico" ou conteúdo que espalha a teoria da "conspiração da Eurábia."

#### **Detecção e fiscalização**

Para aplicar nossas regras contra o comportamento de ódio, usamos uma combinação de tecnologia e especialistas em confiança e segurança. Trabalhamos por meio de nosso Canal de Parceiros da Comunidade junto a diversos parceiros da comunidade. Aproveitamos a tecnologia de moderação automatizada para identificar e remover o conteúdo de ódio junto a revisão de um moderador humano.

Detecção e fiscalização automáticas

Revisão humana

## **Capacitação da nossa comunidade**

Investimos em ajudar as pessoas a personalizar sua experiência no TikTok e a manter o controle com diversos recursos e ferramentas, incluindo:

* Os criadores podem organizar sua seção de comentários excluindo comentários ou restringindo quem pode vê-los. Também oferecemos mais opções para os criadores personalizarem a experiência com filtros de Comentários,incluindo**:**
...
- Inadequados, ofensivos ou indecentes
...
Confira alguns dos trabalhos que fazemos para interagir com nossa comunidade, tanto para ensinar quanto para aprender com ela:
