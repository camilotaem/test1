...
No TikTok, você tem autonomia para gerenciar sua experiência. Oferecemos um [kit de ferramentas de segurança](https://www.tiktok.com/safety/community-controls/?lang=pt-BR) que permite personalizar suas preferências de conteúdo e [configurações da conta](https://support.tiktok.com/pt-BR/account-and-privacy), além de gerenciar interações. Além disso, para alguns conteúdos, você verá telas ou banners de inscrição que oferecem mais contexto sobre uma publicação.

Você também pode acessar os recursos da nossa [Central de Segurança](https://www.tiktok.com/safety?lang=pt-BR) para receber mais suporte.
