...
* by using EDPO’s online request form at <https://edpo.com/telegram-gdpr-data-request/> or
...
Users following a sufficient number of large public one-to-many channels (e.g., *Finance, Business & Entrepreneurship, or Humor & Memes*), may see ads from that category in other large public channels or in other bots as well. Users may also see ads selected on the basis of the channels they follow. This data is never passed to advertisers.
...
You can alter or revoke the bot’s permissions, including the list of chats it can access, at any time from *Settings > Telegram Business > Chatbots* on official Telegram clients.
...
* Added information about [Telegram Business chatbots](/blog/telegram-business#chatbots-for-business) to the [Bot Messages](#6-bot-messages) section (6.2, 6.3, 6.5).
...
If you have any questions please feel free to explore our [FAQ](https://telegram.org/faq) or contact Telegram's Volunteer Support in-app via *Settings > Ask a Question*.
...
* Confirm that Telegram apps downloaded from app stores are using the same code that we publish at: <https://core.telegram.org/reproducible-builds>