...
No Facebook, exigimos que as pessoas criem uma conta indicando o nome que elas usam no dia a dia e que representa a identidade verdadeira delas. Criamos [Perfis adicionais](https://www.facebook.com/help/967154637433480) para ajudar as pessoas a expressar diferentes partes da identidade delas, como seus interesses ou negócios.

***Alterações na política:** podemos exigir que você verifique sua identidade para acessar ou continuar usando determinados produtos e recursos. Caso a verificação não seja concluída, poderemos tomar medidas que incluem, entre outras, a restrição de acesso ou a desativação permanente das contas.*

Não permitimos o uso dos nossos serviços e restringiremos ou desativaremos contas do Instagram, do Facebook e do Threads, bem como outras entidades do Facebook (como Páginas e grupos) que:
...
* Se envolvam em declarações falsas de identidade para enganar ou iludir outras pessoas, burlar o monitoramento ou violar nossos Padrões da Comunidade. Consideramos uma série de fatores ao avaliar a declaração falsa de identidade, como:
  ...
  + Alterações repetidas ou significativas nas informações de identidade, como nome ou idade.
  + Informações de perfil enganosas, como detalhes da biografia e localização do perfil.
  + Uso de imagem do banco de imagens
* Uso de um nome que viole nossos Padrões da Comunidade.

No Facebook, buscaremos mais informações antes de tomarmos ações, que vão desde a restrição temporária até a desativação permanente de perfis e contas, se você:
