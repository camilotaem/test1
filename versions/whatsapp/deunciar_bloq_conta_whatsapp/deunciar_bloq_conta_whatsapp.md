...
* Após bloquear um contato, você terá a opção de **Desbloquear** ou **Apagar a conversa**. Além disso, o WhatsApp exibirá a opção de arquivar a conversa. Caso não queira denunciar a conta, desmarque a opção **Denunciar ao WhatsApp**.
