...
Você pode denunciar qualquer conteúdo problemático ao WhatsApp. Para deixar de receber mensagens, ligações e atualizações de status de determinados contatos ou números de telefone, você pode bloqueá-los. Bloquear e denunciar usuários problemáticos ajuda a manter o WhatsApp seguro. Saiba como bloquear e denunciar uma conta [neste artigo](https://faq.whatsapp.com/1142481766359885?helpref=faq_content).
